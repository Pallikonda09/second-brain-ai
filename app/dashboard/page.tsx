    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "32px 16px" }}>
        ...
        {loading ? (
              ...
              <div key={i} className="card" style={{ padding: "20px 24px" }}>
                <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div className="skeleton" style={{ height: 12, width: "75%", marginBottom: 12 }} />
          ...
          <div className="animate-fade-up" style={{ textAlign: "center", padding: "80px 0" }}>
            <div style={{ fontSize: 48, marginBottom: 16 }}>🧠</div>
            <h2 style={{ fontSize: 20, fontWeight: 600, color: "var(--text-primary)", marginBottom: 8 }}>
              Your knowledge base is empty
            </h2>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: isExpanded ? "0 4px 24px rgba(108,99,255,0.15)" : "none",
                ...
                >
                  {/* ── Card Header ── */}
                  <div onClick={() => toggleExpand(item._id)}
                    style={{ padding: "20px 24px", cursor: "pointer" }}>
                    <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{
                          ...
                          <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
                            {item.tags.map(tag => (
                              <span key={tag} className="tag" style={{ transition: "all 0.2s" }}>{tag}</span>
                            ))}
                          </div>
                          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            <span style={{ fontSize: 11, color: "var(--text-muted)", whiteSpace: "nowrap" }}>
